...
export default function Products() {
  ...
  // Queries
  const { data: productsResponse = { data: [] }, isLoading } = useQuery({
  ...
  const filteredProducts = (products as any[]).filter((product: any) => {
    const name = product.name || product.fully_qualified_name || "";
    ...
    const matchesCategory = selectedCategory === "all" || product.category === selectedCategory || !product.category;
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-lg font-semibold text-foreground">{product.name || product.fully_qualified_name}</h3>
                        {getTypeBadge(product)}
                        {(product.category || product.taxclassificationref_name) && (
                      ...
                      <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium text-foreground">
                            ${parseFloat(product.unitprice || product.salesprice || 0).toFixed(2)}
                          </span>
                        </div>
                        {product.qtyonhand !== null && (
                          <div>
                            <span>{product.qtyonhand}</span>
                          </div>
                        )}
                        <div>
